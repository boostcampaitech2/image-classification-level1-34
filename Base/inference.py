...
def load_model(saved_model, num_classes, device):
    ...
    model_path = os.path.join(saved_model, '2_24_accuracy_88.23%_f1_100.00%.pth')   # need to change
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_CHANNEL_MODEL', './model/Jin_resnet_newcutmix_2'))                           # need to change
